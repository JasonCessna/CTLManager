...
<cffunction name="pushNewPlayer">
	...
	<cfhttp method="put" url="https://sheets.googleapis.com/v4/spreadsheets/#teamID#/values/Sheet1!A:append">
		...
		<cfhttpparam type="header" name="includevaluesInResponse" value="true">
		<cfhttpparam type="header" name="responseValueRenderOption" value="FORMATTED_VALUE">
		<cfhttpparam type="header" name="responseDateTimeRenderOption" value="FORMATTED_STRING">
		<cfhttpparam type="body" value="#postBody#">
	</cfhttp>
	<cfset response = cfhttp>
	<cfreturn cfhttp.filecontent>
