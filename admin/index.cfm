...
<cfswitch expression="#url.section#">
 <!------------------------
	...
	<cfset weekLineup = getWeeklyLineup(session.token.access_token,getLineupRange)>
		...
		<cfform name="frmTemplate" method="POST" action="http://ctl.manage.org/admin/?section=display">
			<div align="center">
	...
	<cfdefaultcase>
		...
		<div align="center">
			...
			<cfif url.teamAccess EQ '#hash("NA")#'> 
			<div id="teamSelectDiv" align="center">
				...
				<cfelse>
					<input type="hidden" name="team"  value="#hash(url.teamAccess)#">
				</cfif>
				<br />
				<div>
