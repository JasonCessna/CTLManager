...
<cfif url.access NEQ hash("ADMIN")>
	...
	<cfswitch expression="#url.section#">
	 <!------------------------
		...
		<cfset weekLineup = getWeeklyLineup(session.token.access_token,getLineupRange)>
			...
			<cfform name="frmTemplate" method="POST" action="http://duttles.com/ctlmanager/admin/index.cfm?section=display&access=#hash(accessLevel)#">
				<div align="center">
		...
		<cfcase value="display">
			...
			<cfif isDefined('form.scoresSubmit')>
				...
				<!---<cfdump var="#ListGetAt(masterScores, 2, ',')#">--->
			...
			<script>
				...
				<cfloop from="1" to="7" index="i">
					TLpad+="&lt;!-- Match #i# \--\> <br />";
					<cfif i NEQ 7>
						TLpad+="|m#i#p1=#ListGetAt(weekResults1.values[i][1],1,"|")# [[File:#aryMapSlot[i][1]#-medium.png|17px]] |m#i#p1race=#Left(ListGetAt(weekResults1.values[i][1],5,"|"),1)# |m#i#p1flag=ff |m#i#p1link=false <br />";
						TLpad+="|m#i#p2=[[File:#aryMapSlot[i][2]#-medium.png|17px]] #ListGetAt(weekResults2.values[i][1],1,"|")# |m#i#p2race=#Left(ListGetAt(weekResults2.values[i][1],5,"|"),1)# |m#i#p2flag=ff |m#i#p2link=false <br />";
						TLpad+="|m1map=#aryMapSlot[i][2]#<br />";
					<cfelse>
						TLpad+="|ace1p1=#ListGetAt(weekResults1.values[i][1],1,"|")# [[File:MasterMedium.png|17px]] |ace1p1race=#Left(ListGetAt(weekResults1.values[i][1],1,"|"),1)# |ace1p1flag=ff |ace1p1link=false <br />";
						TLpad+="|ace1p2=[[File:MasterMedium.png|17px]] #ListGetAt(weekResults2.values[i][1],1,"|")# |ace1p2race=#Left(ListGetAt(weekResults2.values[i][1],5,"|"),1)# |ace1p2flag=ff |ace1p2link=false <br />";
						TLpad+="|ace1map=#aryMapSlot[i][2]# LE <br />";
						TLpad+="|ace1win= <br />";
						TLpad+="\&lt;!-- Match 8 --> <br />";
						TLpad+="|ace2p1=#ListGetAt(weekResults1.values[i][1],1,"|")# [[File:MasterMedium.png|17px]] |ace2p1race=#Left(ListGetAt(weekResults1.values[i][1],1,"|"),1)# |ace2p1flag=ff |ace2p1link=false <br />";
						TLpad+="|ace2p2=[[File:MasterMedium.png|17px]] #ListGetAt(weekResults2.values[i][1],1,"|")# |ace2p2race=#Left(ListGetAt(weekResults2.values[i][1],5,"|"),1)# |ace2p2flag=ff |ace2p2link=false <br />";
						TLpad+="|ace2map= <br />";
						TLpad+="|ace2win= <br />";
						TLpad+="\&lt;!--Match 9 --> <br />";
						TLpad+="|ace3p1= [[File:MasterMedium.png|17px]] |ace3p1race=T |ace3p1flag=ff |ace3p1link=false <br />";
						TLpad+="|ace3p2=[[File:MasterMedium.png|17px]] |ace3p2race=P |ace3p2flag=ff |ace3p2link=false <br />";
						TLpad+="|ace3map= <br />";
						TLpad+="|ace3win= <br />";
						TLpad+="}} <br />";
					</cfif>
				...
				<cfloop from="1" to="7" index="i">
					wikiPad+='&lt;img src="#structIMG[ListGetAt(weekResults2.values[i][1],5,"|")]#" /&gt; &lt;a href="#ListGetAt(weekResults2.values[i][1],1,"|")#"&gt;#ListGetAt(weekResults2.values[i][1],1,"|")# | #ListGetAt(weekResults2.values[i][1],2,"|")#&lt;/a&gt; vs. &lt;a href="#ListGetAt(weekResults1.values[i][1],3,"|")#"&gt;#ListGetAt(weekResults1.values[i][1],1,"|")# | #ListGetAt(weekResults1.values[i][1],2,"|")#&lt;/a&gt; &lt;img src="#structIMG[ListGetAt(weekResults1.values[i][1],5,"|")]#" /&gt; &lt;i&gt;[#aryMapSlot[i][2]#&lt;/i&gt;&lt;br /&gt <br />';
				</cfloop>
		...
		------------------------->
		<cfdefaultcase>
			<cfform name="frmTemplate" method="POST" action="http://duttles.com/ctlmanager/admin/index.cfm&access=#hash(accessLevel)#">
			<div align="center">
