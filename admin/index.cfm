	...
	<cfswitch expression="#url.section#">
	 <!------------------------
		...
		<cfset weekLineup = getWeeklyLineup(session.token.access_token,getLineupRange)>
			...
			<cfform name="frmTemplate" method="POST" action="http://ctl.manage.org/admin/?section=display&access=#hash(accessLevel)#">
				<div align="center">
		...
		------------------------->
		<cfdefaultcase>
			<cfform name="frmTemplate" method="POST" action="http://ctl.manage.org/admin/&access=#hash(accessLevel)#">
			<div align="center">
