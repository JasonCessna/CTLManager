...
<cffunction name="getAuth" access="private" returnType="string" output="false">
	...
	<cfreturn variables.authdata[arguments.service].auth>
		...
		<!--- 	
		API Key: 		AIzaSyCBzN_gxpJzZYCf7SRSGbLvZ2i9twURcaI
		client id:  	589990717034-671kugskgj65a6tpt7rofngmh2i2bmpc.apps.googleusercontent.com 
		client secret:  rZUSiH9vUxiQcCjqfNoK2iZL  
		--->